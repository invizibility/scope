...
func libJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "lib.js", size: 24323, mode: os.FileMode(420), modTime: time.Unix(1486135662, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
