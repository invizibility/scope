...
func libJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "lib.js", size: 2703, mode: os.FileMode(420), modTime: time.Unix(1485464412, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
